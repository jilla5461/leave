...
<div class="container-fluid">
  ...
  <button type="button" class="btn btn-danger btn-md mr-3"
  onclick="location.href='<?php echo base_url('leave/admin_history'); ?>'">
  Admin Leave History
</button>
<button type="button" class="btn btn-danger btn-md"
  onclick="location.href='<?php echo base_url('leave/leavependingrequests'); ?>'">
  leave request
</button> 
<hr>
